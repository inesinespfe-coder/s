oot@ines-VM:/opt/soc/nusantara/wazuh-docker/single-node/custom-integrations# cd ../
root@ines-VM:/opt/soc/nusantara/wazuh-docker/single-node# cat docker-compose.yml 
...
root@ines-VM:/opt/soc/nusantara/wazuh-docker/single-node# ls
config  custom-integrations  docker-compose.yml  generate-indexer-certs.yml  README.md  wazuh-agent.deb
root@ines-VM:/opt/soc/nusantara/wazuh-docker/single-node# ls custom-integrations/
add_shufflewazuh_config.conf   add_vtwazuh_config-server.conf  custom-iris.py  custom-misp.py    custom-wazuh_iris.py  ossec.conf
add_vtwazuh_config-agent.conf  add_vtwazuh_rules.xml           custom-misp     custom-ollama.py  local_rules.xml       remove-threat.sh
root@ines-VM:/opt/soc/nusantara/wazuh-docker/single-node# 
